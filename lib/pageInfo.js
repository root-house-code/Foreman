...
export const PAGE_INFO = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "In the desktop app, turn on Multi-Device Sharing (under Integrations) and scan the QR code to use Foreman live from your phone or another computer on the same wifi.",
    ],
    sharedWith: [
