...
export const PAGE_INFO = [
  ...
  },
  {
    ...
    title: "Dashboard",
    valueProp:
      "Your home's state at a glance — an overall health dial, a Triage queue of what's overdue or due this week, and a T−30→T+90 schedule. The place to start a daily or weekly check-in.",
    howTo: [
      "Scan the health dial and Triage queue for what needs attention now.",
      "Sort any panel by clicking its column header.",
      "Click a To Do or Project to edit inline; click a Triage row to open its source.",
    ],
    sharedWith: [
      { key: "maintenance", why: "Overdue/upcoming tasks drive Triage, the schedule, and system/room health." },
  ...
  },
  {
    ...
    howTo: [
      ...
      "Use the Replacement Forecast tab to see items aging toward replacement and edit each one's lifespan.",
    ],
    sharedWith: [
  ...
  },
  {
    ...
    title: "Mortgage",
    valueProp:
      "Your home loan as Foreman models it — a default monthly payment with an escrow split and per-month corrections — the financing line that rides on top of operating costs.",
    howTo: [
      "Set the default monthly payment and the escrow portion (taxes + insurance).",
      "Correct any single month from the payment ledger when the amount changes.",
      "The Forecast adds this on top of the operating run-rate as total monthly outlay.",
    ],
    sharedWith: [
