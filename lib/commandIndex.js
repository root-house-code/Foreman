...
const PAGES = [
  ...
  ["workbench", "Workbench"],
  ["board", "To Dos"], ["projects", "Projects"], ["ledger", "Ledger"], ["forecast", "Forecast"],
  ["guide", "Notebook"], ["timeline", "Timeline"], ["preferences", "Preferences"], ["readme", "Read Me"],
];
...
export const COMMAND_ACTIONS = [
  { id: "act-session", type: "action", label: "Start a work session", sublabel: "Workbench", target: "workbench", navState: { openBuilder: true } },
  ...
  { id: "act-expense", type: "action", label: "Log an expense",     sublabel: "Ledger",    target: "ledger",   navState: { openAdd: true } },
  { id: "act-budget",  type: "action", label: "View operating budget", sublabel: "Forecast", target: "forecast" },
